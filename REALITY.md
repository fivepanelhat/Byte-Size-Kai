...
| **Demo (3 commands)** | See GETTING_STARTED.md | bootstrap → validate → main loop |
| **Focus role** | **P0 commercial wedge** (agritech) | Sister portals are supporting |

Compliance / sovereignty docs are **design targets**, not external certifications.
