...
Detailed historical changelogs (architecture, MQTT, GPIO, flywheel, validation, and install narratives) are **commercial-track / private**.

See [`README.md`](./README.md) · [`PUBLIC_POSTURE.md`](./PUBLIC_POSTURE.md) · [`REALITY.md`](./REALITY.md) · [`NOTICE.md`](./NOTICE.md).

Prior public changelog blobs and removed paths may remain in git history until a history scrub (separate HITL).
