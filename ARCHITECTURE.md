...
- ✓ **Fast inference** — ~100-200ms per token on RPi 5 CPU; faster with AI Top Hat NPU acceleration
...
### NPU Acceleration (AI Top Hat)

The AI Top Hat PCIe accelerator offloads neural inference:
